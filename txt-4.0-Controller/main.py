from lib.controller import *  # pyright: ignore[reportMissingImports]
import asyncio
import json
import websockets
...
def setMotors(fl, fr, rl, rr):
    _apply(front_left, fl) # pyright: ignore[reportUndefinedVariable]
    _apply(front_right, -fr) # pyright: ignore[reportUndefinedVariable]
    _apply(rear_left, rl) # pyright: ignore[reportUndefinedVariable]
    _apply(rear_right, -rr) # pyright: ignore[reportUndefinedVariable]
